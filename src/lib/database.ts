...
export type UserRankingsPlayer =
  Database["public"]["Tables"]["user_rankings_players"]["Row"];
export type UserRankingsSet =
  Database["public"]["Tables"]["user_rankings_sets"]["Row"];
