  ...
  useEffect(() => {
    const updateEffectiveTheme = () => {
      ...
      if (newEffectiveTheme === 'light') {
        ...
        document.documentElement.style.setProperty('--theme-bg-tertiary', '#f1f5f9');
        document.documentElement.style.setProperty('--theme-bg-card', '#ffffff');
        document.documentElement.style.setProperty('--theme-bg-sidebar', '#f8fafc');
        ...
        document.documentElement.style.setProperty('--theme-text-tertiary', '#64748b');
        document.documentElement.style.setProperty('--theme-border', '#e2e8f0');
        document.documentElement.style.setProperty('--theme-border-hover', '#cbd5e1');
        document.documentElement.style.setProperty('--theme-shadow', '0 1px 3px 0 rgb(0 0 0 / 0.1), 0 1px 2px -1px rgb(0 0 0 / 0.1)');
      } else {
        ...
        document.documentElement.style.setProperty('--theme-bg-tertiary', '#334155');
        document.documentElement.style.setProperty('--theme-bg-card', '#1e293b');
        document.documentElement.style.setProperty('--theme-bg-sidebar', '#0f172a');
        ...
        document.documentElement.style.setProperty('--theme-text-tertiary', '#94a3b8');
        document.documentElement.style.setProperty('--theme-border', '#334155');
        document.documentElement.style.setProperty('--theme-border-hover', '#475569');
        document.documentElement.style.setProperty('--theme-shadow', '0 4px 6px -1px rgb(0 0 0 / 0.1), 0 2px 4px -2px rgb(0 0 0 / 0.1)');
      }
    };
