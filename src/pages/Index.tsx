...
import { Trophy, BarChart3, TrendingUp, Users, ArrowRight, Brain, Target, Zap } from 'lucide-react';
        ...
        <div className="max-w-5xl mx-auto text-center">
          <div className="mb-8">
            ...
            <p className="text-xl text-slate-400 mb-8 max-w-3xl mx-auto">
              Make smarter decisions with advanced analytics, AI-powered projections, and real-time market intelligence. 
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 max-w-2xl mx-auto">
            ...
            <div className="text-center">
              <div className="text-2xl md:text-3xl font-bold text-emerald-400">50K+</div>
              <div className="text-sm text-slate-400">Users</div>
            </div>
            <div className="text-center">
              <div className="text-2xl md:text-3xl font-bold text-emerald-400">$2.1M</div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-slate-400 max-w-2xl mx-auto">
              Professional-grade analytics tools that give you the competitive edge in every matchup
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="bg-slate-800/50 border border-slate-700/50 rounded-xl p-6 text-center hover:bg-slate-800/70 transition-colors">
              ...
              <h3 className="text-lg font-semibold text-white mb-2">Advanced Player Projections</h3>
              <p className="text-slate-400 text-sm">
                AI-powered projections using advanced algorithms and real-time data
              </p>
            </div>
            ...
            <div className="bg-slate-800/50 border border-slate-700/50 rounded-xl p-6 text-center hover:bg-slate-800/70 transition-colors">
              ...
              <h3 className="text-lg font-semibold text-white mb-2">AI-Powered Trade Analysis</h3>
              <p className="text-slate-400 text-sm">
            ...
            <div className="bg-slate-800/50 border border-slate-700/50 rounded-xl p-6 text-center hover:bg-slate-800/70 transition-colors">
              ...
              <h3 className="text-lg font-semibold text-white mb-2">Real-Time Market Intelligence</h3>
              <p className="text-slate-400 text-sm">
            ...
            <div className="bg-slate-800/50 border border-slate-700/50 rounded-xl p-6 text-center hover:bg-slate-800/70 transition-colors">
              ...
              <h3 className="text-lg font-semibold text-white mb-2">League Integration</h3>
              <p className="text-slate-400 text-sm">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-white mb-3">Connect Your League</h3>
              <p className="text-slate-400">
                Link your fantasy platforms and we'll sync all your team data automatically
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-slate-400">
                Our advanced algorithms analyze thousands of data points to provide actionable insights
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-white mb-3">Dominate Your League</h3>
              <p className="text-slate-400">
                Make data-driven decisions and watch your win rate soar to new heights
              </p>
            </div>
          </div>
        </div>
