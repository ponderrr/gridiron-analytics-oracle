...
export const StatCard: React.FC<StatCardProps> = ({
  ...
  return (
    <FantasyCard variant={variant} className={cn("p-6", className)} glow>
...
export const PlayerCard: React.FC<PlayerCardProps> = ({
  ...
  const getTierVariant = (): "default" | "premium" | "elite" | "champion" => {
    ...
    >
      ...
      <div className="relative z-10">
            ...
            {tier && (
              <span
                className={cn(
                  ...
                  getTierVariant() === "elite" &&
                    "bg-purple-500/20 text-purple-400",
                  getTierVariant() === "premium" &&
                    "bg-blue-500/20 text-blue-400",
                  getTierVariant() === "champion" &&
                    "bg-yellow-500/20 text-yellow-400",
                  getTierVariant() === "default" &&
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          {points && (
            <div className="bg-slate-900/50 rounded-lg p-3 text-center">
              <div className="text-xl font-bold text-white mb-1">{points}</div>
