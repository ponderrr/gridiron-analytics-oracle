...
export function PlayerCard({
  ...
  const getPositionColor = (position: string) => {
    switch (position) {
      case 'QB': return 'bg-red-500/20 text-red-300 border-red-500/30';
      ...
      case 'TE': return 'bg-yellow-500/20 text-yellow-300 border-yellow-500/30';
      case 'K': return 'bg-purple-500/20 text-purple-300 border-purple-500/30';
      case 'D/ST': return 'bg-orange-500/20 text-orange-300 border-orange-500/30';
